...
public class URLs {
    ...
    public static final String URL_TEACHERLOGIN= "https://intellispiritapp.000webhostapp.com/api.php?apicall=teacher_login";
    public static final String URL_PRINCIPALLOGIN= "https://intellispiritapp.000webhostapp.com/api.php?apicall=principal_login";
